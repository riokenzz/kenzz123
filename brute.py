...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"        Hallo,Selamat datang di tools saya ^^     
    runntxt(WW+"        Gunakan Tools Ini Dengan Bijak Yaa
    runntxt(GL+"        Contact saya? riokenzz@gmail.com
    runntxt(GG+"        Website : Kenzz Blogs [KenzzBlogsID]
    runntxt(Y+"    
    runntxt(GG+"  
    time.sleep(1.5)
    print GG+"  √=============================================√"
    ...
    print GG+"  √=============================================√"
    print WW+"  |          CREATED BY: IQBALZnoobs            |"
    print GL+"  |           Recode by: Mr.SW4GH4T Aka Kenzz   |"
    print WW+"  |            FACEBOOK: Ryuu Kenzz             |"
    print Y+"   |             INSTAGRAM: Rio_Id539            |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        NO COLI NO LIFE [ N.C.N.L ]          |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         https://www.github.com/RioKenzz "
...
def pil():
                ...
                if g == 'y' or g == 'Y':
                    ...
                    print "          P A S S W O R D  K E T E M U "
                    print RR+"+-------------------------------------------+"
                    ...
                    `-/+///..````..://+/-`
                    `.-::////::-.` \033[91;1m
                    \033[90;1mNo Coli No Life\033[91;1m
                    Powered by:\033[97m Ryuu Kenzz
                    """
